      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          <div className="bg-gray-50 px-6 py-4 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-600 mt-1">View essential project details and metadata</p>
          </div>
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                  <p className="text-gray-700 leading-relaxed break-words text-base max-w-md">
                    {project?.name}
                  </p>
                  <p className="text-xs text-gray-500 mt-1">
                    {project?.name?.length || 0}/100 characters
                  </p>
                </div>
              </div>
                ...
                <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                  <div className="flex items-center space-x-2">
                    <span className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium ${
                      ...
                      {userRole ? getRoleDisplayInfo(userRole).label : 'Unknown'}
                    </span>
                  </div>
                  <p className="text-xs text-gray-500 mt-1">
                    {userRole === 'admin' ? 'Full project control and management' :
                     userRole === 'editor' ? 'Can create and manage content' :
                ...
                <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="min-w-0">
                      <p className="font-medium text-gray-900 break-words">{project?.creator?.fullName}</p>
              ...
              <div className="space-y-2">
                ...
                <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    {project?.createdAt ? `${Math.floor((new Date().getTime() - new Date(project.createdAt).getTime()) / (1000 * 60 * 60 * 24))} days ago` : ''}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 space-y-2">
              ...
              <div className="p-4 bg-gray-50 rounded-lg border border-gray-200 overflow-hidden">
                {project?.description ? (
                  <>
                    <p className="text-gray-700 leading-relaxed break-all text-base w-full overflow-wrap-break-word">
                      {project.description}
                    </p>
            ...
            <div className="bg-white rounded-lg p-6 w-full max-w-lg max-h-[90vh] overflow-y-auto">
              ...
              <div className="mb-4">
                <p className="text-gray-600 mb-4 leading-relaxed">
                  Are you sure you want to archive this project? The project will be hidden from your dashboard but can be restored later.
                </p>
                
                <div className="mb-4 p-3 bg-amber-50 rounded-lg">
                  <p className="text-sm text-gray-600">Project to be archived:</p>
                  <p className="text-lg font-bold text-amber-900 break-words leading-tight mt-1">{project?.name}</p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg p-6 w-full max-w-lg max-h-[90vh] overflow-y-auto">
              ...
              <div className="mb-4">
                ...
                <div className="mb-4 p-3 bg-red-50 rounded-lg">
                  <p className="text-sm text-gray-600">Project to be deleted:</p>
                  <p className="text-lg font-bold text-red-900 break-words leading-tight mt-1">{project?.name}</p>
                </div>
